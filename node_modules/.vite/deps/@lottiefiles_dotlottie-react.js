import {
  require_jsx_runtime
} from "./chunk-QYT5MDVP.js";
import {
  require_react
} from "./chunk-H2BVA2C6.js";
import {
  __toESM
...
var N3 = (h, i, n) => i in h ? H3(h, i, { enumerable: true, configurable: true, writable: true, value: n }) : h[i] = n;
var m = (h, i, n) => N3(h, typeof i != "symbol" ? i + "" : i, n);
var G3 = class {
...
var J3 = class {
  constructor() {
    m(this, "_strategy"), this._strategy = typeof requestAnimationFrame == "function" ? new G3() : new V3();
  }
  requestAnimationFrame(h) {
...
var E = typeof window < "u" && typeof window.document < "u";
var _2 = new Uint8Array([80, 75, 3, 4]);
var q3 = ["v", "ip", "op", "layers", "fr", "w", "h"];
var X2 = "0.55.0";
var Q2 = "@lottiefiles/dotlottie-web";
var K3 = 0.75;
var X3 = 4;
var Q3 = (() => {
  ...
  return function(i = {}) {
    var n;
    function u(t, e, a) {
      return (e = _(e)) in t ? Object.defineProperty(t, e, { value: a, enumerable: true, configurable: true, writable: true }) : t[e] = a, t;
    }
    function _(t) {
      var e = y(t, "string");
    ...
    var c = i, W, V, J = new Promise((t, e) => {
      W = t, V = e;
    }), m1 = Object.assign({}, c), d1 = "./this.program", D = "", c1;
    typeof document < "u" && document.currentScript && (D = document.currentScript.src), h && (D = h), D.startsWith("blob:") ? D = "" : D = D.substr(0, D.replace(/[?#].*/, "").lastIndexOf("/") + 1), c1 = async (t) => {
      if (t = await fetch(t, { credentials: "same-origin" }), t.ok) return t.arrayBuffer();
      throw Error(t.status + " : " + t.url);
    };
    var q = c.printErr || console.error.bind(console);
    Object.assign(c, m1), m1 = null, c.thisProgram && (d1 = c.thisProgram);
    var i1 = c.wasmBinary, K, l1 = false, _1, z, O, n1, Z, w, C, g1, L1;
    function r1() {
      var t = K.buffer;
      c.HEAP8 = z = new Int8Array(t), c.HEAP16 = n1 = new Int16Array(t), c.HEAPU8 = O = new Uint8Array(t), c.HEAPU16 = Z = new Uint16Array(t), c.HEAP32 = w = new Int32Array(t), c.HEAPU32 = C = new Uint32Array(t), c.HEAPF32 = g1 = new Float32Array(t), c.HEAPF64 = L1 = new Float64Array(t);
    }
    var A1 = [], x = [], w1 = [];
    function i3() {
    ...
    function k1(t) {
      var e;
      throw (e = c.onAbort) === null || e === void 0 || e.call(c, t), t = "Aborted(" + t + ")", q(t), l1 = true, t = new WebAssembly.RuntimeError(t + ". Build with -sASSERTIONS for more info."), V(t), t;
    }
    var g2 = (t) => t.startsWith("data:application/octet-stream;base64,"), D1;
    async function n3(t) {
      if (!i1) try {
        var e = await c1(t);
      ...
      if (t == D1 && i1) t = new Uint8Array(i1);
    ...
    async function a3(t, e) {
      try {
        ...
        q(`failed to asynchronously prepare wasm: ${r}`), k1(r);
      }
    }
    async function r3(t) {
      var e = D1;
      if (!i1 && typeof WebAssembly.instantiateStreaming == "function" && !g2(e) && typeof fetch == "function") try {
        var a = fetch(e, { credentials: "same-origin" });
        return await WebAssembly.instantiateStreaming(a, t);
      } catch (r) {
        q(`wasm streaming compile failed: ${r}`), q("falling back to ArrayBuffer instantiation");
      }
      return a3(e, t);
    }
    class L2 {
      constructor(e) {
        u(this, "name", "ExitStatus"), this.message = `Program terminated with exit(${e})`, this.status = e;
      }
    }
    var X1 = (t) => {
      for (; 0 < t.length; ) t.shift()(c);
    }, Q1 = c.noExitRuntime || true, w2 = typeof TextDecoder < "u" ? new TextDecoder() : void 0, T1 = function() {
      let t = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : 0, e = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : NaN;
      var a = O, r = t + e;
      for (e = t; a[e] && !(e >= r); ) ++e;
      if (16 < e - t && a.buffer && w2) return w2.decode(a.subarray(t, e));
      for (r = ""; t < e; ) {
        var s = a[t++];
        if (s & 128) {
          var o = a[t++] & 63;
          if ((s & 224) == 192) r += String.fromCharCode((s & 31) << 6 | o);
          else {
            var l = a[t++] & 63;
            s = (s & 240) == 224 ? (s & 15) << 12 | o << 6 | l : (s & 7) << 18 | o << 12 | l << 6 | a[t++] & 63, 65536 > s ? r += String.fromCharCode(s) : (s -= 65536, r += String.fromCharCode(55296 | s >> 10, 56320 | s & 1023));
          }
    ...
    var f1 = {}, o1 = {}, R1 = {}, b1, a1 = (t, e, a) => {
      function r(d) {
        if (d = a(d), d.length !== t.length) throw new b1("Mismatched type converter count");
        for (var f = 0; f < t.length; ++f) j(t[f], d[f]);
      }
      t.forEach((d) => R1[d] = e);
      var s = Array(e.length), o = [], l = 0;
      e.forEach((d, f) => {
        o1.hasOwnProperty(d) ? s[f] = o1[d] : (o.push(d), f1.hasOwnProperty(d) || (f1[d] = []), f1[d].push(() => {
          s[f] = o1[d], ++l, l === o.length && r(s);
        }));
      }), o.length === 0 && r(s);
    }, y2, A = (t) => {
      for (var e = ""; O[t]; ) e += y2[O[t++]];
      return e;
    }, g;
    function o3(t, e) {
      let a = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {};
      var r = e.name;
      if (!t) throw new g(`type "${r}" must have a positive integer typeid pointer`);
      if (o1.hasOwnProperty(t)) {
        if (a.hb) return;
        throw new g(`Cannot register type '${r}' twice`);
      }
      o1[t] = e, delete R1[t], f1.hasOwnProperty(t) && (e = f1[t], delete f1[t], e.forEach((s) => s()));
    }
    function j(t, e) {
      let a = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {};
      return o3(t, e, a);
    ...
    }, b2 = (t, e, a) => e === a ? t : a.Ga === void 0 ? null : (t = b2(t, e, a.Ga), t === null ? null : a.$a(t)), I2 = {}, h3 = {}, u3 = (t, e) => {
      if (e === void 0) throw new g("ptr should not be undefined");
      for (; t.Ga; ) e = t.Qa(e), t = t.Ga;
      return h3[e];
    }, W1 = (t, e) => {
      if (!e.Da || !e.Ca) throw new b1("makeClassHandle requires ptr and ptrType");
      if (!!e.Ha != !!e.Fa) throw new b1("Both smartPtrType and smartPtr must be specified");
      return e.count = { value: 1 }, I1(Object.create(t, { Aa: { value: e, writable: true } }));
    }, I1 = (t) => typeof FinalizationRegistry > "u" ? (I1 = (e) => e, t) : (t2 = new FinalizationRegistry((e) => {
      e = e.Aa, --e.count.value, e.count.value === 0 && (e.Fa ? e.Ha.Ka(e.Fa) : e.Da.Ba.Ka(e.Ca));
    }), I1 = (e) => {
      var a = e.Aa;
      return a.Fa && t2.register(e, { Aa: a }, e), e;
    }, C2 = (e) => {
      t2.unregister(e);
    }, I1(t));
    function x1() {
    }
    var S1 = (t, e) => Object.defineProperty(e, "name", { value: t }), S2 = (t, e, a) => {
      if (t[e].Ea === void 0) {
        var r = t[e];
        t[e] = function() {
          for (var s = arguments.length, o = new Array(s), l = 0; l < s; l++) o[l] = arguments[l];
          if (!t[e].Ea.hasOwnProperty(o.length)) throw new g(`Function '${a}' called with an invalid number of arguments (${o.length}) - expects one of (${t[e].Ea})!`);
          return t[e].Ea[o.length].apply(this, o);
        }, t[e].Ea = [], t[e].Ea[r.Na] = r;
      }
    }, e2 = (t, e, a) => {
      if (c.hasOwnProperty(t)) {
        if (a === void 0 || c[t].Ea !== void 0 && c[t].Ea[a] !== void 0) throw new g(`Cannot register public name '${t}' twice`);
        if (S2(c, t, t), c[t].Ea.hasOwnProperty(a)) throw new g(`Cannot register multiple overloads of a function with the same number of arguments (${a})!`);
        c[t].Ea[a] = e;
      } else c[t] = e, c[t].Na = a;
    }, d3 = (t) => {
    ...
    function c3(t, e, a, r, s, o, l, d) {
      this.name = t, this.constructor = e, this.Ma = a, this.Ka = r, this.Ga = s, this.bb = o, this.Qa = l, this.$a = d, this.jb = [];
    }
    var i2 = (t, e, a) => {
      for (; e !== a; ) {
        if (!e.Qa) throw new g(`Expected null or instance of ${a.name}, got an instance of ${e.name}`);
        t = e.Qa(t), e = e.Ga;
      }
      return t;
    };
    function l3(t, e) {
      ...
      if (!e.Aa) throw new g(`Cannot pass "${o2(e)}" as a ${this.name}`);
      if (!e.Aa.Ca) throw new g(`Cannot pass deleted object as a pointer of type ${this.name}`);
      return i2(e.Aa.Ca, e.Aa.Da.Ba, this.Ba);
    }
    function _3(t, e) {
      if (e === null) {
        if (this.Ta) throw new g(`null is not a valid ${this.name}`);
        if (this.Sa) {
          var a = this.Ua();
          return t !== null && t.push(this.Ka, a), a;
        }
        return 0;
      }
      if (!e || !e.Aa) throw new g(`Cannot pass "${o2(e)}" as a ${this.name}`);
      if (!e.Aa.Ca) throw new g(`Cannot pass deleted object as a pointer of type ${this.name}`);
      if (!this.Ra && e.Aa.Da.Ra) throw new g(`Cannot convert argument of type ${e.Aa.Ha ? e.Aa.Ha.name : e.Aa.Da.name} to parameter type ${this.name}`);
      if (a = i2(e.Aa.Ca, e.Aa.Da.Ba, this.Ba), this.Sa) {
        if (e.Aa.Fa === void 0) throw new g("Passing raw pointer to smart pointer is illegal");
        switch (this.ob) {
          case 0:
            if (e.Aa.Ha === this) a = e.Aa.Fa;
            else throw new g(`Cannot convert argument of type ${e.Aa.Ha ? e.Aa.Ha.name : e.Aa.Da.name} to parameter type ${this.name}`);
            break;
          case 1:
            a = e.Aa.Fa;
            break;
          case 2:
            if (e.Aa.Ha === this) a = e.Aa.Fa;
              ...
              var r = e.clone();
              a = this.kb(a, $1(() => r.delete())), t !== null && t.push(this.Ka, a);
            }
            break;
          default:
    ...
    function f3(t, e) {
      ...
      if (!e.Aa) throw new g(`Cannot pass "${o2(e)}" as a ${this.name}`);
      if (!e.Aa.Ca) throw new g(`Cannot pass deleted object as a pointer of type ${this.name}`);
      if (e.Aa.Da.Ra) throw new g(`Cannot convert argument of type ${e.Aa.Da.name} to parameter type ${this.name}`);
      return i2(e.Aa.Ca, e.Aa.Da.Ba, this.Ba);
    }
    function P1(t, e, a, r, s, o, l, d, f, p, v) {
      this.name = t, this.Ba = e, this.Ta = a, this.Ra = r, this.Sa = s, this.ib = o, this.ob = l, this.Ya = d, this.Ua = f, this.kb = p, this.Ka = v, s || e.Ga !== void 0 ? this.toWireType = _3 : (this.toWireType = r ? l3 : f3, this.Ja = null);
    }
    var P2 = (t, e, a) => {
      if (!c.hasOwnProperty(t)) throw new b1("Replacing nonexistent public symbol");
      c[t].Ea !== void 0 && a !== void 0 ? c[t].Ea[a] = e : (c[t] = e, c[t].Na = a);
    }, U, v3 = function(t, e) {
      let a = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : [];
      return t.includes("j") ? (t = t.replace(/p/g, "i"), e = (0, c["dynCall_" + t])(e, ...a)) : e = U.get(e)(...a), e;
    }, p3 = (t, e) => function() {
      for (var a = arguments.length, r = new Array(a), s = 0; s < a; s++) r[s] = arguments[s];
      return v3(t, e, r);
    }, T = (t, e) => {
      t = A(t);
      var a = t.includes("j") ? p3(t, e) : U.get(e);
      if (typeof a != "function") throw new g(`unknown function pointer with signature ${t}: ${e}`);
      return a;
    }, O2, E2 = (t) => {
      t = $2(t);
      var e = A(t);
      ...
      function a(o) {
        s[o] || o1[o] || (R1[o] ? R1[o].forEach(a) : (r.push(o), s[o] = true));
      }
      var r = [], s = {};
      throw e.forEach(a), new O2(`${t}: ` + r.map(E2).join([", "]));
    }, n2 = (t, e) => {
      for (var a = [], r = 0; r < t; r++) a.push(C[e + 4 * r >> 2]);
      return a;
    };
    function m3(t) {
      for (var e = 1; e < t.length; ++e) if (t[e] !== null && t[e].Ja === void 0) return true;
      return false;
    }
    function a2(t, e, a, r, s) {
      var o = e.length;
      if (2 > o) throw new g("argTypes array size mismatch! Must at least get return value and 'this' types!");
      var l = e[1] !== null && a !== null, d = m3(e), f = e[0].name !== "void", p = o - 2, v = Array(p), M = [], b = [];
      return S1(t, function() {
        for (var $ = arguments.length, S = new Array($), H = 0; H < $; H++) S[H] = arguments[H];
        if (b.length = 0, M.length = l ? 2 : 1, M[0] = s, l) {
          var R = e[1].toWireType(b, this);
          M[1] = R;
        }
        for (var P = 0; P < p; ++P) v[P] = e[P + 2].toWireType(b, S[P]), M.push(v[P]);
        if (S = r(...M), d) Y1(b);
        else for (P = l ? 1 : 2; P < e.length; P++) {
          var F = P === 1 ? R : v[P - 2];
          e[P].Ja !== null && e[P].Ja(F);
        }
        return R = f ? e[0].fromWireType(S) : void 0, R;
      });
    }
    var A2 = (t) => {
      t = t.trim();
      ...
      9 < t && --t1[t + 1] === 0 && (t1[t] = void 0, r2.push(t));
    }, v1 = (t) => {
      ...
      switch (t) {
        ...
        case false:
          return 8;
        default:
          let e = r2.pop() || t1.length;
          return t1[e] = t, t1[e + 1] = 1, e;
      }
    }, k2 = { name: "emscripten::val", fromWireType: (t) => {
      var e = v1(t);
      return s2(t), e;
    }, toWireType: (t, e) => $1(e), Ia: 8, readValueFromPointer: C1, Ja: null }, g3 = (t, e, a) => {
      switch (e) {
        case 1:
          return a ? function(r) {
            return this.fromWireType(z[r]);
          } : function(r) {
            return this.fromWireType(O[r]);
          };
        case 2:
          return a ? function(r) {
            return this.fromWireType(n1[r >> 1]);
          } : function(r) {
      ...
      var a = o1[t];
      if (a === void 0) throw t = `${e} has unknown type ${E2(t)}`, new g(t);
      return a;
    }, o2 = (t) => {
      ...
      switch (e) {
        case 4:
          return function(a) {
            return this.fromWireType(g1[a >> 2]);
          };
        case 8:
          return function(a) {
            return this.fromWireType(L1[a >> 3]);
          };
        default:
      ...
      switch (e) {
        case 1:
          return a ? (r) => z[r] : (r) => O[r];
        case 2:
          return a ? (r) => n1[r >> 1] : (r) => Z[r >> 1];
        case 4:
          return a ? (r) => w[r >> 2] : (r) => C[r >> 2];
        default:
          throw new TypeError(`invalid integer width (${e}): ${t}`);
      }
    }, M3 = Object.assign({ optional: true }, k2), D2 = typeof TextDecoder < "u" ? new TextDecoder("utf-16le") : void 0, y3 = (t, e) => {
      for (var a = t >> 1, r = a + e / 2; !(a >= r) && Z[a]; ) ++a;
      if (a <<= 1, 32 < a - t && D2) return D2.decode(O.subarray(t, a));
      for (a = "", r = 0; !(r >= e / 2); ++r) {
        var s = n1[t + 2 * r >> 1];
        if (s == 0) break;
      ...
      var r;
      if ((r = a) !== null && r !== void 0 || (a = 2147483647), 2 > a) return 0;
      a -= 2;
      var s = e;
      a = a < 2 * t.length ? a / 2 : t.length;
      for (var o = 0; o < a; ++o) n1[e >> 1] = t.charCodeAt(o), e += 2;
      return n1[e >> 1] = 0, e - s;
    }, b3 = (t) => 2 * t.length, I3 = (t, e) => {
      for (var a = 0, r = ""; !(a >= e / 4); ) {
        var s = w[t + 4 * a >> 2];
        if (s == 0) break;
        ++a, 65536 <= s ? (s -= 65536, r += String.fromCharCode(55296 | s >> 10, 56320 | s & 1023)) : r += String.fromCharCode(s);
      }
      return r;
    }, S3 = (t, e, a) => {
      var r;
      if ((r = a) !== null && r !== void 0 || (a = 2147483647), 4 > a) return 0;
      var s = e;
      a = s + a - 4;
      for (var o = 0; o < t.length; ++o) {
        ...
        if (w[e >> 2] = l, e += 4, e + 4 > a) break;
      }
      return w[e >> 2] = 0, e - s;
    }, P3 = (t) => {
      for (var e = 0, a = 0; a < t.length; ++a) {
        var r = t.charCodeAt(a);
        55296 <= r && 57343 >= r && ++a, e += 4;
      }
      return e;
    }, h2 = 0, T2 = (t, e, a) => {
      var r = [];
      return t = t.toWireType(r, a), r.length && (C[e >> 2] = $1(r)), t;
    }, u2 = [], O3 = (t) => {
      var e = u2.length;
      return u2.push(t), e;
    }, E3 = (t, e) => {
      for (var a = Array(t), r = 0; r < t; ++r) a[r] = B1(C[e + 4 * r >> 2], "parameter " + r);
      return a;
    }, A3 = Reflect.construct, O1 = {}, F2 = (t) => {
      if (!(t instanceof L2 || t == "unwind")) throw t;
    }, R2 = (t) => {
      var e;
      throw _1 = t, Q1 || 0 < h2 || ((e = c.onExit) !== null && e !== void 0 && e.call(c, t), l1 = true), new L2(t);
    }, k3 = (t) => {
      if (!l1) try {
        if (t(), !(Q1 || 0 < h2)) try {
          _1 = t = _1, R2(t);
      ...
      if (!c2) {
        var t = { USER: "web_user", LOGNAME: "web_user", PATH: "/", PWD: "/", HOME: "/home/web_user", LANG: (typeof navigator == "object" && navigator.languages && navigator.languages[0] || "C").replace("-", "_") + ".UTF-8", _: d1 || "./this.program" }, e;
        for (e in d2) d2[e] === void 0 ? delete t[e] : t[e] = d2[e];
        var a = [];
    ...
    b1 = c.InternalError = class extends Error {
      constructor(t) {
        super(t), this.name = "InternalError";
      }
    };
    for (var U2 = Array(256), z1 = 0; 256 > z1; ++z1) U2[z1] = String.fromCharCode(z1);
    y2 = U2, g = c.BindingError = class extends Error {
      constructor(t) {
        super(t), this.name = "BindingError";
      }
    }, Object.assign(x1.prototype, { isAliasOf: function(t) {
      if (!(this instanceof x1 && t instanceof x1)) return false;
      var e = this.Aa.Da.Ba, a = this.Aa.Ca;
      t.Aa = t.Aa;
      var r = t.Aa.Da.Ba;
      for (t = t.Aa.Ca; e.Ga; ) a = e.Qa(a), e = e.Ga;
      for (; r.Ga; ) t = r.Qa(t), r = r.Ga;
      return e === r && a === t;
    }, clone: function() {
      if (this.Aa.Ca || Z1(this), this.Aa.Pa) return this.Aa.count.value += 1, this;
      var t = I1, e = Object, a = e.create, r = Object.getPrototypeOf(this), s = this.Aa;
      return t = t(a.call(e, r, { Aa: { value: { count: s.count, Oa: s.Oa, Pa: s.Pa, Ca: s.Ca, Da: s.Da, Fa: s.Fa, Ha: s.Ha } } })), t.Aa.count.value += 1, t.Aa.Oa = false, t;
    }, delete() {
      if (this.Aa.Ca || Z1(this), this.Aa.Oa && !this.Aa.Pa) throw new g("Object already scheduled for deletion");
      C2(this);
      var t = this.Aa;
      --t.count.value, t.count.value === 0 && (t.Fa ? t.Ha.Ka(t.Fa) : t.Da.Ba.Ka(t.Ca)), this.Aa.Pa || (this.Aa.Fa = void 0, this.Aa.Ca = void 0);
    }, isDeleted: function() {
      return !this.Aa.Ca;
    }, deleteLater: function() {
      if (this.Aa.Ca || Z1(this), this.Aa.Oa && !this.Aa.Pa) throw new g("Object already scheduled for deletion");
      return this.Aa.Oa = true, this;
    } }), Object.assign(P1.prototype, { cb(t) {
      return this.Ya && (t = this.Ya(t)), t;
    }, Wa(t) {
      var e;
      (e = this.Ka) === null || e === void 0 || e.call(this, t);
    }, Ia: 8, readValueFromPointer: C1, fromWireType: function(t) {
      function e() {
        return this.Sa ? W1(this.Ba.Ma, { Da: this.ib, Ca: a, Ha: this, Fa: t }) : W1(this.Ba.Ma, { Da: this, Ca: t });
      }
      var a = this.cb(t);
      if (!a) return this.Wa(t), null;
      var r = u3(this.Ba, a);
      if (r !== void 0) return r.Aa.count.value === 0 ? (r.Aa.Ca = a, r.Aa.Fa = t, r.clone()) : (r = r.clone(), this.Wa(t), r);
      if (r = this.Ba.bb(a), r = I2[r], !r) return e.call(this);
      r = this.Ra ? r.Za : r.pointerType;
      var s = b2(a, this.Ba, r.Ba);
      return s === null ? e.call(this) : this.Sa ? W1(r.Ba.Ma, { Da: r, Ca: s, Ha: this, Fa: t }) : W1(r.Ba.Ma, { Da: r, Ca: s });
    } }), O2 = c.UnboundTypeError = ((t, e) => {
      var a = S1(e, function(r) {
        this.name = e, this.message = r, r = Error(r).stack, r !== void 0 && (this.stack = this.toString() + `
` + r.replace(/^Error(:[^\n]*)?\n/, ""));
      });
      return a.prototype = Object.create(t.prototype), a.prototype.constructor = a, a.prototype.toString = function() {
        return this.message === void 0 ? this.name : `${this.name}: ${this.message}`;
      }, a;
    })(Error, "UnboundTypeError"), t1.push(0, 1, void 0, 1, null, 1, true, 1, false, 1), c.count_emval_handles = () => t1.length / 2 - 5 - r2.length;
    var T3 = { c: (t, e, a, r) => k1(`Assertion failed: ${t ? T1(t) : ""}, at: ` + [e ? e ? T1(e) : "" : "unknown filename", a, r ? r ? T1(r) : "" : "unknown function"]), j: (t, e, a) => {
      var r = new s3(t);
      throw C[r.Ca + 16 >> 2] = 0, C[r.Ca + 4 >> 2] = e, C[r.Ca + 8 >> 2] = a, M2 = t, M2;
    }, P: () => {
    }, M: () => {
    }, N: () => {
    }, R: function() {
      ...
      var e = F1[t];
      delete F1[t];
      var a = e.Ua, r = e.Ka, s = e.Xa, o = s.map((l) => l.gb).concat(s.map((l) => l.mb));
      a1([t], o, (l) => {
        var d = {};
        return s.forEach((f, p) => {
          var v = l[p], M = f.eb, b = f.fb, $ = l[p + s.length], S = f.lb, H = f.nb;
          d[f.ab] = { read: (R) => v.fromWireType(M(b, R)), write: (R, P) => {
            var F = [];
            S(H, R, $.toWireType(F, P)), Y1(F);
          } };
        }), [{ name: e.name, fromWireType: (f) => {
          var p = {}, v;
          for (v in d) p[v] = d[v].read(f);
          return r(f), p;
        }, toWireType: (f, p) => {
          for (var v in d) if (!(v in p)) throw new TypeError(`Missing field: "${v}"`);
          var M = a();
          for (v in d) d[v].write(M, p[v]);
          return f !== null && f.push(r, M), M;
        }, Ia: 8, readValueFromPointer: C1, Ja: r }];
      });
    }, F: () => {
    }, _: (t, e, a, r) => {
      e = A(e), j(t, { name: e, fromWireType: function(s) {
        return !!s;
    ...
    }, m: (t, e, a, r, s, o, l, d, f, p, v, M, b) => {
      v = A(v), o = T(s, o), d && (d = T(l, d)), p && (p = T(f, p)), b = T(M, b);
      var $ = d3(v);
      e2($, function() {
        U1(`Cannot construct ${v} due to unbound types`, [r]);
      }), a1([t, e, a], r ? [r] : [], (S) => {
        if (S = S[0], r) var H = S.Ba, R = H.Ma;
        else R = x1.prototype;
        S = S1(v, function() {
          if (Object.getPrototypeOf(this) !== P) throw new g("Use 'new' to construct " + v);
          if (F.La === void 0) throw new g(v + " has no accessible constructor");
          for (var H2 = arguments.length, H1 = new Array(H2), N1 = 0; N1 < H2; N1++) H1[N1] = arguments[N1];
          var N2 = F.La[H1.length];
          if (N2 === void 0) throw new g(`Tried to invoke ctor of ${v} with invalid number of parameters (${H1.length}) - expected (${Object.keys(F.La).toString()}) parameters instead!`);
          return N2.apply(this, H1);
        });
        var P = Object.create(R, { constructor: { value: S } });
        S.prototype = P;
        var F = new c3(v, S, P, b, H, o, d, p);
        if (F.Ga) {
          var j2, E1;
          (j2 = (E1 = F.Ga).Va) !== null && j2 !== void 0 || (E1.Va = []), F.Ga.Va.push(F);
        }
        return H = new P1(v, F, true, false, false), E1 = new P1(v + "*", F, false, false, false), R = new P1(v + " const*", F, false, true, false), I2[t] = { pointerType: E1, Za: R }, P2($, S), [H, E1, R];
      });
    }, r: (t, e, a, r, s, o) => {
      var l = n2(e, a);
      s = T(r, s), a1([], [t], (d) => {
        d = d[0];
        var f = `constructor ${d.name}`;
        if (d.Ba.La === void 0 && (d.Ba.La = []), d.Ba.La[e - 1] !== void 0) throw new g(`Cannot register multiple constructors with identical number of parameters (${e - 1}) for class '${d.name}'! Overload resolution is currently only performed using the parameter count, not actual type info!`);
        return d.Ba.La[e - 1] = () => {
          U1(`Cannot construct ${d.name} due to unbound types`, l);
        }, a1([], l, (p) => (p.splice(1, 0, null), d.Ba.La[e - 1] = a2(f, p, null, s, o), [])), [];
      });
    }, d: (t, e, a, r, s, o, l, d) => {
      var f = n2(a, r);
      e = A(e), e = A2(e), o = T(s, o), a1([], [t], (p) => {
        function v() {
          U1(`Cannot call ${M} due to unbound types`, f);
        }
        p = p[0];
        var M = `${p.name}.${e}`;
        e.startsWith("@@") && (e = Symbol[e.substring(2)]), d && p.Ba.jb.push(e);
        var b = p.Ba.Ma, $ = b[e];
        return $ === void 0 || $.Ea === void 0 && $.className !== p.name && $.Na === a - 2 ? (v.Na = a - 2, v.className = p.name, b[e] = v) : (S2(b, e, M), b[e].Ea[a - 2] = v), a1([], f, (S) => (S = a2(M, S, p, o, l), b[e].Ea === void 0 ? (S.Na = a - 2, b[e] = S) : b[e].Ea[a - 2] = S, [])), [];
      });
    }, Y: (t) => j(t, k2), D: (t, e, a, r) => {
      function s() {
      }
      e = A(e), s.values = {}, j(t, { name: e, constructor: s, fromWireType: function(o) {
        return this.constructor.values[o];
      }, toWireType: (o, l) => l.value, Ia: 8, readValueFromPointer: g3(e, a, r), Ja: null }), e2(e, s);
    }, l: (t, e, a) => {
      var r = B1(t, "enum");
      e = A(e), t = r.constructor, r = Object.create(r.constructor.prototype, { value: { value: a }, constructor: { value: S1(`${r.name}_${e}`, function() {
      }) } }), t.values[a] = r, t[e] = r;
    }, A: (t, e, a) => {
      e = A(e), j(t, { name: e, fromWireType: (r) => r, toWireType: (r, s) => s, Ia: 8, readValueFromPointer: L3(e, a), Ja: null });
    }, v: (t, e, a, r, s, o) => {
      var l = n2(e, a);
      t = A(t), t = A2(t), s = T(r, s), e2(t, function() {
        U1(`Cannot call ${t} due to unbound types`, l);
      }, e - 1), a1([], l, (d) => (P2(t, a2(t, [d[0], null].concat(d.slice(1)), null, s, o), e - 1), []));
    }, n: (t, e, a, r, s) => {
      if (e = A(e), s === -1 && (s = 4294967295), s = (d) => d, r === 0) {
        var o = 32 - 8 * a;
        s = (d) => d << o >>> o;
      }
      var l = e.includes("unsigned") ? function(d, f) {
        return f >>> 0;
      } : function(d, f) {
        return f;
      };
      j(t, { name: e, fromWireType: s, toWireType: l, Ia: 8, readValueFromPointer: w3(e, a, r !== 0), Ja: null });
    }, g: (t, e, a) => {
      function r(o) {
        return new s(z.buffer, C[o + 4 >> 2], C[o >> 2]);
      }
      var s = [Int8Array, Uint8Array, Int16Array, Uint16Array, Int32Array, Uint32Array, Float32Array, Float64Array][e];
      a = A(a), j(t, { name: a, fromWireType: r, Ia: 8, readValueFromPointer: r }, { hb: true });
    }, q: (t) => {
      j(t, M3);
    }, u: (t, e, a, r, s, o, l, d, f, p, v, M) => {
      a = A(a), o = T(s, o), d = T(l, d), p = T(f, p), M = T(v, M), a1([t], [e], (b) => (b = b[0], [new P1(a, b.Ba, false, false, true, b, r, o, d, p, M)]));
    }, Z: (t, e) => {
      e = A(e), j(t, { name: e, fromWireType: function(a) {
        for (var r = C[a >> 2], s = a + 4, o, l = s, d = 0; d <= r; ++d) {
          var f = s + d;
          (d == r || O[f] == 0) && (l = l ? T1(l, f - l) : "", o === void 0 ? o = l : (o += "\0", o += l), l = f + 1);
        }
        return e1(a), o;
      }, toWireType: function(a, r) {
        r instanceof ArrayBuffer && (r = new Uint8Array(r));
        var s, o = typeof r == "string";
        if (!(o || r instanceof Uint8Array || r instanceof Uint8ClampedArray || r instanceof Int8Array)) throw new g("Cannot pass non-string to std::string");
        if (o) for (var l = s = 0; l < r.length; ++l) {
          var d = r.charCodeAt(l);
          127 >= d ? s++ : 2047 >= d ? s += 2 : 55296 <= d && 57343 >= d ? (s += 4, ++l) : s += 3;
        }
        else s = r.length;
        if (l = l2(4 + s + 1), d = l + 4, C[l >> 2] = s, o) y1(r, d, s + 1);
        else if (o) for (o = 0; o < s; ++o) {
          var f = r.charCodeAt(o);
          if (255 < f) throw e1(d), new g("String has UTF-16 code units that do not fit in 8 bits");
          O[d + o] = f;
        }
        else for (o = 0; o < s; ++o) O[d + o] = r[o];
        return a !== null && a.push(e1, l), l;
      }, Ia: 8, readValueFromPointer: C1, Ja(a) {
        e1(a);
      } });
    }, y: (t, e, a) => {
      if (a = A(a), e === 2) var r = y3, s = C3, o = b3, l = (d) => Z[d >> 1];
      else e === 4 && (r = I3, s = S3, o = P3, l = (d) => C[d >> 2]);
      j(t, { name: a, fromWireType: (d) => {
        for (var f = C[d >> 2], p, v = d + 4, M = 0; M <= f; ++M) {
          var b = d + 4 + M * e;
          (M == f || l(b) == 0) && (v = r(v, b - v), p === void 0 ? p = v : (p += "\0", p += v), v = b + e);
        }
        return e1(d), p;
      }, toWireType: (d, f) => {
        if (typeof f != "string") throw new g(`Cannot pass non-string to C++ string type ${a}`);
        var p = o(f), v = l2(4 + p + e);
        return C[v >> 2] = p / e, s(f, v + 4, p + e), d !== null && d.push(e1, v), v;
      }, Ia: 8, readValueFromPointer: C1, Ja(d) {
        e1(d);
      } });
    }, x: (t, e, a, r, s, o) => {
      F1[t] = { name: A(e), Ua: T(a, r), Ka: T(s, o), Xa: [] };
    }, i: (t, e, a, r, s, o, l, d, f, p) => {
      F1[t].Xa.push({ ab: A(e), gb: a, eb: T(r, s), fb: o, mb: l, lb: T(d, f), nb: p });
    }, $: (t, e) => {
      e = A(e), j(t, { pb: true, name: e, Ia: 0, fromWireType: () => {
      }, toWireType: () => {
      } });
    }, K: () => {
      Q1 = false, h2 = 0;
      ...
      throw 1 / 0;
    }, C: (t, e, a) => (t = v1(t), e = B1(e, "emval::as"), T2(e, a, t)), p: (t, e, a, r) => (t = u2[t], e = v1(e), t(null, e, a, r)), W: s2, E: (t, e) => (t = v1(t), e = v1(e), t == e), o: (t, e, a) => {
      var r = E3(t, e), s = r.shift();
      t--;
      var o = Array(t);
      return e = `methodCaller<(${r.map((l) => l.name).join(", ")}) => ${s.name}>`, O3(S1(e, (l, d, f, p) => {
        for (var v = 0, M = 0; M < t; ++M) o[M] = r[M].readValueFromPointer(p + v), v += r[M].Ia;
        return l = a === 1 ? A3(d, o) : d.apply(l, o), T2(s, f, l);
      }));
    }, z: (t) => {
      9 < t && (t1[t + 1] += 1);
    }, ca: (t) => {
      var e = v1(t);
      Y1(e), s2(t);
    }, t: (t, e) => (t = B1(t, "_emval_take_value"), t = t.readValueFromPointer(e), $1(t)), G: (t, e) => {
      if (O1[t] && (clearTimeout(O1[t].id), delete O1[t]), !e) return 0;
      var a = setTimeout(() => {
        delete O1[t], k3(() => B2(t, performance.now()));
      }, e);
      return O1[t] = { id: a, qb: e }, 0;
    }, H: (t, e, a, r) => {
      var s = (/* @__PURE__ */ new Date()).getFullYear(), o = new Date(s, 0, 1).getTimezoneOffset();
      s = new Date(s, 6, 1).getTimezoneOffset(), C[t >> 2] = 60 * Math.max(o, s), w[e >> 2] = +(o != s), e = (l) => {
        var d = Math.abs(l);
        return `UTC${0 <= l ? "-" : "+"}${String(Math.floor(d / 60)).padStart(2, "0")}${String(d % 60).padStart(2, "0")}`;
      }, t = e(o), e = e(s), s < o ? (y1(t, a, 17), y1(e, r, 17)) : (y1(t, r, 17), y1(e, a, 17));
    }, ba: () => performance.now(), J: (t) => {
      var e = O.length;
      ...
      for (var a = 1; 4 >= a; a *= 2) {
        ...
        t: {
          r = (Math.min(2147483648, 65536 * Math.ceil(Math.max(t, r) / 65536)) - K.buffer.byteLength + 65535) / 65536 | 0;
          try {
            K.grow(r), r1();
            var s = 1;
            break t;
      ...
      var a = 0;
      return W2().forEach((r, s) => {
        var o = e + a;
        for (s = C[t + 4 * s >> 2] = o, o = 0; o < r.length; ++o) z[s++] = r.charCodeAt(o);
        z[s] = 0, a += r.length + 1;
      }), 0;
    }, X: (t, e) => {
      var a = W2();
      C[t >> 2] = a.length;
      var r = 0;
      return a.forEach((s) => r += s.length + 1), C[e >> 2] = r, 0;
    }, S: () => 52, Q: () => 52, k: F3, f: U3, e: z3, B: R3, aa: B3, a: W3, b: $3, h: x3, s: j3, U: R2, L: (t, e) => (x2(O.subarray(t, t + e)), 0) }, I;
    (async function(t, e) {
      function a(o) {
        var l;
        return I = o.exports, K = I.da, r1(), U = I.ga, x.unshift(I.ea), s1--, (l = c.monitorRunDependencies) === null || l === void 0 || l.call(c, s1), s1 == 0 && M1 && (o = M1, M1 = null, o()), I;
      }
      s1++, (t = c.monitorRunDependencies) === null || t === void 0 || t.call(c, s1);
      var r = { a: T3 };
      if (c.instantiateWasm) try {
        return c.instantiateWasm(r, a);
      } catch (o) {
        q(`Module.instantiateWasm callback failed with error: ${o}`), V(o);
      }
      (e = D1) !== null && e !== void 0 || (D1 = g2("DotLottiePlayer.wasm") ? "DotLottiePlayer.wasm" : c.locateFile ? c.locateFile("DotLottiePlayer.wasm", D) : D + "DotLottiePlayer.wasm");
      try {
        var s = await r3(r);
        return a(s.instance), s;
      } catch (o) {
        V(o);
      }
    })();
    var l2 = (t) => (l2 = I.fa)(t), e1 = (t) => (e1 = I.ha)(t), $2 = (t) => ($2 = I.ia)(t), B2 = (t, e) => (B2 = I.ja)(t, e), X = (t, e) => (X = I.ka)(t, e), Q = (t) => (Q = I.la)(t), Y = () => (Y = I.ma)();
    c.dynCall_jiii = (t, e, a, r) => (c.dynCall_jiii = I.na)(t, e, a, r), c.dynCall_jii = (t, e, a) => (c.dynCall_jii = I.oa)(t, e, a), c.dynCall_vjii = (t, e, a, r, s) => (c.dynCall_vjii = I.pa)(t, e, a, r, s), c.dynCall_vjfii = (t, e, a, r, s, o) => (c.dynCall_vjfii = I.qa)(t, e, a, r, s, o), c.dynCall_vjiii = (t, e, a, r, s, o) => (c.dynCall_vjiii = I.ra)(t, e, a, r, s, o), c.dynCall_vj = (t, e, a) => (c.dynCall_vj = I.sa)(t, e, a), c.dynCall_vjiiiii = (t, e, a, r, s, o, l, d) => (c.dynCall_vjiiiii = I.ta)(t, e, a, r, s, o, l, d), c.dynCall_vjiffii = (t, e, a, r, s, o, l, d) => (c.dynCall_vjiffii = I.ua)(t, e, a, r, s, o, l, d), c.dynCall_vjiiii = (t, e, a, r, s, o, l) => (c.dynCall_vjiiii = I.va)(t, e, a, r, s, o, l), c.dynCall_viijii = (t, e, a, r, s, o, l) => (c.dynCall_viijii = I.wa)(t, e, a, r, s, o, l), c.dynCall_iiiiij = (t, e, a, r, s, o, l) => (c.dynCall_iiiiij = I.xa)(t, e, a, r, s, o, l), c.dynCall_iiiiijj = (t, e, a, r, s, o, l, d, f) => (c.dynCall_iiiiijj = I.ya)(t, e, a, r, s, o, l, d, f), c.dynCall_iiiiiijj = (t, e, a, r, s, o, l, d, f, p) => (c.dynCall_iiiiiijj = I.za)(t, e, a, r, s, o, l, d, f, p);
    function F3(t, e) {
      var a = Y();
      try {
        return U.get(t)(e);
      } catch (r) {
        if (Q(a), r !== r + 0) throw r;
        X(1, 0);
      }
    }
    function R3(t, e, a, r, s, o) {
      var l = Y();
      try {
        return U.get(t)(e, a, r, s, o);
      } catch (d) {
        if (Q(l), d !== d + 0) throw d;
        X(1, 0);
      }
    }
    function W3(t, e) {
    ...
    function z3(t, e, a, r) {
      var s = Y();
      try {
        return U.get(t)(e, a, r);
      } catch (o) {
        if (Q(s), o !== o + 0) throw o;
        X(1, 0);
      }
    }
    function j3(t, e, a, r, s) {
      var o = Y();
      try {
        U.get(t)(e, a, r, s);
      } catch (l) {
        if (Q(o), l !== l + 0) throw l;
        X(1, 0);
      }
    }
    var j1;
    ...
    function z2() {
      function t() {
        if (!j1 && (j1 = true, c.calledRun = true, !l1)) {
          var e;
          if (X1(x), W(c), (e = c.onRuntimeInitialized) === null || e === void 0 || e.call(c), c.postRun) for (typeof c.postRun == "function" && (c.postRun = [c.postRun]); c.postRun.length; ) {
      ...
      if (!(0 < s1)) {
        if (c.preRun) for (typeof c.preRun == "function" && (c.preRun = [c.preRun]); c.preRun.length; ) i3();
        X1(A1), 0 < s1 || (c.setStatus ? (c.setStatus("Running..."), setTimeout(() => {
          setTimeout(() => c.setStatus(""), 1), t();
        }, 1)) : t());
      }
    }
    if (c.preInit) for (typeof c.preInit == "function" && (c.preInit = [c.preInit]); 0 < c.preInit.length; ) c.preInit.pop()();
    return z2(), n = J, n;
  };
})();
var Y3 = Q3;
var G1 = class {
  ...
  static async _tryLoad(h) {
    return await Y3({ locateFile: () => h });
  }
  static async _loadWithBackup() {
    return this._ModulePromise || (this._ModulePromise = this._tryLoad(this._wasmURL).catch(async (h) => {
      let i = `https://unpkg.com/${Q2}@${X2}/dist/dotlottie-player.wasm`;
      console.warn(`Primary WASM load failed from ${this._wasmURL}. Error: ${h.message}`), console.warn(`Attempting to load WASM from backup URL: ${i}`);
      try {
        return await this._tryLoad(i);
      } catch (n) {
        throw console.error(`Primary WASM URL failed: ${h.message}`), console.error(`Backup WASM URL failed: ${n.message}`), new Error("WASM loading failed from all sources.");
      }
    })), this._ModulePromise;
  }
  static async load() {
  ...
  static setWasmUrl(h) {
    h !== this._wasmURL && (this._wasmURL = h, this._ModulePromise = null);
  }
};
m(G1, "_ModulePromise", null), m(G1, "_wasmURL", `https://cdn.jsdelivr.net/npm/${Q2}@${X2}/dist/dotlottie-player.wasm`);
var Y2 = class {
  constructor() {
    m(this, "_eventListeners", /* @__PURE__ */ new Map());
  }
  addEventListener(h, i) {
    let n = this._eventListeners.get(h);
    n || (n = /* @__PURE__ */ new Set(), this._eventListeners.set(h, n)), n.add(i);
  }
  removeEventListener(h, i) {
    let n = this._eventListeners.get(h);
    n && (i ? (n.delete(i), n.size === 0 && this._eventListeners.delete(h)) : this._eventListeners.delete(h));
  }
  dispatch(h) {
    this._eventListeners.get(h.type)?.forEach((i) => i(h));
  }
...
var N = class {
  static _initializeObserver() {
    ...
    let h = (i) => {
      i.forEach((n) => {
        let u = this._observedCanvases.get(n.target);
        u && (n.isIntersecting ? u.unfreeze() : u.freeze());
      });
    };
    this._observer = new IntersectionObserver(h, { threshold: 0 });
  }
  static observe(h, i) {
    this._initializeObserver(), !this._observedCanvases.has(h) && (this._observedCanvases.set(h, i), this._observer?.observe(h));
  }
  static unobserve(h) {
    this._observer?.unobserve(h), this._observedCanvases.delete(h), this._observedCanvases.size === 0 && (this._observer?.disconnect(), this._observer = null);
  }
};
m(N, "_observer", null), m(N, "_observedCanvases", /* @__PURE__ */ new Map());
var G = class {
  static _initializeObserver() {
    if (this._observer) return;
    let h = (i) => {
      i.forEach((n) => {
        ...
        this._observedCanvases.set(n.target, [_, c]);
      });
    };
    this._observer = new ResizeObserver(h);
  }
  static observe(h, i) {
    this._initializeObserver(), !this._observedCanvases.has(h) && (this._observedCanvases.set(h, [i, 0]), this._observer?.observe(h));
  }
  static unobserve(h) {
    let i = this._observedCanvases.get(h);
    if (i) {
      let n = i[1];
      n && clearTimeout(n);
    }
    this._observer?.unobserve(h), this._observedCanvases.delete(h), !this._observedCanvases.size && this._observer && (this._observer.disconnect(), this._observer = null);
  }
};
m(G, "_observer", null), m(G, "_observedCanvases", /* @__PURE__ */ new Map());
function Z3(h) {
  return /^#([\da-f]{6}|[\da-f]{8})$/iu.test(h);
}
function t0(h) {
  if (!Z3(h)) return 0;
  let i = h.replace("#", "");
...
function G2(h) {
  ...
  let i = new Uint8Array(h.slice(0, _2.byteLength));
  for (let n = 0; n < _2.length; n += 1) if (_2[n] !== i[n]) return false;
  return true;
}
function V2(h) {
  return q3.every((i) => Object.prototype.hasOwnProperty.call(h, i));
}
function J2(h) {
  if (typeof h == "string") try {
    return V2(JSON.parse(h));
  } catch {
    return false;
  }
  else return V2(h);
...
function u1() {
  return 1 + ((E ? window.devicePixelRatio : 1) - 1) * K3;
}
function p1(h) {
  let i = h.getBoundingClientRect(), n = window.innerHeight || document.documentElement.clientHeight, u = window.innerWidth || document.documentElement.clientWidth;
  return !(i.bottom < 0 || i.top > n || i.right < 0 || i.left > u);
}
function B(h) {
  let i = h.target;
  if (i instanceof HTMLCanvasElement) {
    let n = i.getBoundingClientRect();
    if (n.width === 0 || n.height === 0 || i.width === 0 || i.height === 0) return null;
    let u = i.width / n.width, _ = i.height / n.height, y = (h.clientX - n.left) * u, c = (h.clientY - n.top) * _;
    return !Number.isFinite(y) || !Number.isFinite(c) || Number.isNaN(y) || Number.isNaN(c) ? null : { x: y, y: c };
  }
  return null;
}
function Z2(h) {
  let i = h.replace("OpenUrl: ", ""), n = i.indexOf(" | Target: "), u, _;
  n === -1 ? (u = i, _ = "_blank") : (u = i.substring(0, n), _ = i.substring(n + 11)), window.open(u, _);
}
var f2 = (h, i) => h === "reverse" ? i.Mode.Reverse : h === "bounce" ? i.Mode.Bounce : h === "reverse-bounce" ? i.Mode.ReverseBounce : i.Mode.Forward;
var e0 = (h, i) => h === "contain" ? i.Fit.Contain : h === "cover" ? i.Fit.Cover : h === "fill" ? i.Fit.Fill : h === "fit-height" ? i.Fit.FitHeight : h === "fit-width" ? i.Fit.FitWidth : i.Fit.None;
var i0 = (h, i) => {
  let n = new i.VectorFloat();
  return n.push_back(h[0]), n.push_back(h[1]), n;
};
var v2 = (h, i) => {
  let n = new i.VectorFloat();
  return h.length !== 2 || (n.push_back(h[0]), n.push_back(h[1])), n;
};
var p2 = (h, i) => h ? { align: i0(h.align ?? [0.5, 0.5], i), fit: e0(h.fit ?? "contain", i) } : i.createDefaultLayout();
var t3 = class L {
  constructor(i) {
    m(this, "_canvas"), m(this, "_context", null), m(this, "_eventManager"), m(this, "_animationFrameId", null), m(this, "_frameManager"), m(this, "_dotLottieCore", null), m(this, "_stateMachineId", ""), m(this, "_stateMachineConfig", null), m(this, "_isStateMachineRunning", false), m(this, "_stateMachineObserverHandle", null), m(this, "_stateMachineInternalMessageObserver", null), m(this, "_dotLottieObserverHandle", null), m(this, "_renderConfig", {}), m(this, "_isFrozen", false), m(this, "_backgroundColor", null), m(this, "_boundOnClick", null), m(this, "_boundOnPointerUp", null), m(this, "_boundOnPointerDown", null), m(this, "_boundOnPointerMove", null), m(this, "_boundOnPointerEnter", null), m(this, "_boundOnPointerLeave", null), this._canvas = i.canvas, this._eventManager = new Y2(), this._frameManager = new J3(), this._renderConfig = { ...i.renderConfig, devicePixelRatio: i.renderConfig?.devicePixelRatio || u1(), freezeOnOffscreen: i.renderConfig?.freezeOnOffscreen ?? true }, G1.load().then((n) => {
      L._wasmModule = n;
      let u = new n.CallbackObserver();
      u.setOnLoad(() => {
        setTimeout(() => {
        ...
        setTimeout(() => {
          this._eventManager.dispatch({ type: "loadError", error: new Error("failed to load") });
        }, 0);
      }), u.setOnPlay(() => {
        setTimeout(() => {
        ...
        setTimeout(() => {
          this._eventManager.dispatch({ type: "loop", loopCount: _ });
        }, 0);
      }), u.setOnComplete(() => {
        setTimeout(() => {
        ...
        setTimeout(() => {
          this._eventManager.dispatch({ type: "frame", currentFrame: _ });
        }, 0);
      }), u.setOnRender((_) => {
        setTimeout(() => {
          this._eventManager.dispatch({ type: "render", currentFrame: _ });
        }, 0);
      }), this._dotLottieCore = new n.DotLottiePlayer({ animationId: i.animationId ?? "", themeId: i.themeId ?? "", stateMachineId: "", autoplay: i.autoplay ?? false, backgroundColor: 0, loopAnimation: i.loop ?? false, loopCount: i.loopCount ?? 0, mode: f2(i.mode ?? "forward", n), segment: v2(i.segment ?? [], n), speed: i.speed ?? 1, useFrameInterpolation: i.useFrameInterpolation ?? true, marker: i.marker ?? "", layout: p2(i.layout, n) }), this._stateMachineId = i.stateMachineId ?? "", this._stateMachineConfig = i.stateMachineConfig ?? null, this._dotLottieObserverHandle = this._dotLottieCore.subscribe(u), this._eventManager.dispatch({ type: "ready" }), i.data ? this._loadFromData(i.data) : i.src && this._loadFromSrc(i.src), i.backgroundColor && this.setBackgroundColor(i.backgroundColor);
    }).catch((n) => {
      this._eventManager.dispatch({ type: "loadError", error: new Error(`Failed to load wasm module: ${n}`) });
    });
  }
  _dispatchError(i) {
  ...
  async _fetchData(i) {
    ...
    return G2(u) ? u : new TextDecoder().decode(u);
  }
  _loadFromData(i) {
    if (this._dotLottieCore === null) return;
    let n = this._canvas.width, u = this._canvas.height, _ = false;
    if (typeof i == "string") {
      if (!J2(i)) {
        this._dispatchError("Invalid Lottie JSON string: The provided string does not conform to the Lottie JSON format.");
        return;
      }
      _ = this._dotLottieCore.loadAnimationData(i, n, u);
  ...
  get layout() {
    ...
    if (i) return { align: [i.align.get(0), i.align.get(1)], fit: (() => {
      switch (i.fit) {
        case L._wasmModule?.Fit.Contain:
          return "contain";
        case L._wasmModule?.Fit.Cover:
          return "cover";
        case L._wasmModule?.Fit.Fill:
          return "fill";
        case L._wasmModule?.Fit.FitHeight:
          return "fit-height";
        case L._wasmModule?.Fit.FitWidth:
          return "fit-width";
        case L._wasmModule?.Fit.None:
          return "none";
        default:
          return "contain";
      }
  ...
  get mode() {
    ...
    return i === L._wasmModule?.Mode.Reverse ? "reverse" : i === L._wasmModule?.Mode.Bounce ? "bounce" : i === L._wasmModule?.Mode.ReverseBounce ? "reverse-bounce" : "forward";
  }
  get isFrozen() {
  ...
  load(i) {
    this._dotLottieCore === null || L._wasmModule === null || (this._stopAnimationLoop(), E && this._canvas instanceof HTMLCanvasElement && (N.unobserve(this._canvas), G.unobserve(this._canvas), this._cleanupStateMachineListeners()), this._isFrozen = false, this._dotLottieCore.setConfig({ animationId: i.animationId ?? "", themeId: i.themeId ?? "", stateMachineId: "", autoplay: i.autoplay ?? false, backgroundColor: 0, loopAnimation: i.loop ?? false, loopCount: i.loopCount ?? 0, mode: f2(i.mode ?? "forward", L._wasmModule), segment: v2(i.segment ?? [], L._wasmModule), speed: i.speed ?? 1, useFrameInterpolation: i.useFrameInterpolation ?? true, marker: i.marker ?? "", layout: p2(i.layout, L._wasmModule) }), i.data ? this._loadFromData(i.data) : i.src && this._loadFromSrc(i.src), this.setBackgroundColor(i.backgroundColor ?? ""));
  }
  _draw() {
    if (this._dotLottieCore !== null && (!this._context && "getContext" in this._canvas && typeof this._canvas.getContext == "function" && (this._context = this._canvas.getContext("2d")), this._context)) {
      let i = this._dotLottieCore.buffer(), n = this._canvas.width * this._canvas.height * X3;
      if (i.byteLength !== n) {
        console.warn(`Buffer size mismatch: got ${i.byteLength}, expected ${n}`);
        return;
      }
      let u = null, _ = new Uint8ClampedArray(i, 0, i.byteLength);
      typeof ImageData > "u" ? (u = this._context.createImageData(this._canvas.width, this._canvas.height), u.data.set(_)) : u = new ImageData(_, this._canvas.width, this._canvas.height), this._context.putImageData(u, 0, 0);
    }
  }
  _stopAnimationLoop() {
  ...
  _startAnimationLoop() {
    this._animationFrameId === null && this._dotLottieCore && !this._isFrozen && (this._dotLottieCore.isPlaying() || this._isStateMachineRunning) && (this._animationFrameId = this._frameManager.requestAnimationFrame(this._animationLoop.bind(this)));
  }
  _animationLoop() {
    ...
    try {
      this._dotLottieCore.tick() && this._draw(), this._animationFrameId = this._frameManager.requestAnimationFrame(this._animationLoop.bind(this));
    } catch (i) {
      console.error("Error in animation frame:", i), this._eventManager.dispatch({ type: "renderError", error: i }), i instanceof WebAssembly.RuntimeError && this.destroy();
    }
  }
  play() {
    this._dotLottieCore === null || !this.isLoaded || (this._stopAnimationLoop(), (this._dotLottieCore.play() || this._dotLottieCore.isPlaying()) && (this._isFrozen = false, this._startAnimationLoop()), E && this._canvas instanceof HTMLCanvasElement && this._renderConfig.freezeOnOffscreen && !p1(this._canvas) && this.freeze());
  }
  pause() {
    this._dotLottieCore !== null && (this._dotLottieCore.pause(), this._stopAnimationLoop());
  }
  stop() {
    if (this._dotLottieCore === null) return;
    let i = this._dotLottieCore.stop();
    this._stopAnimationLoop(), i && (this._eventManager.dispatch({ type: "frame", currentFrame: this.currentFrame }), this._dotLottieCore.render(), this._draw());
  }
  setFrame(i) {
    this._dotLottieCore !== null && this._dotLottieCore.seek(i) && this._dotLottieCore.render() && this._draw();
  }
  setSpeed(i) {
    this._dotLottieCore !== null && this._dotLottieCore.setConfig({ ...this._dotLottieCore.config(), speed: i });
  }
  setBackgroundColor(i) {
    this._dotLottieCore !== null && (E && this._canvas instanceof HTMLCanvasElement ? this._canvas.style.backgroundColor = i : this._dotLottieCore.setConfig({ ...this._dotLottieCore.config(), backgroundColor: t0(i) }), this._backgroundColor = i);
  }
  setLoop(i) {
    this._dotLottieCore !== null && this._dotLottieCore.setConfig({ ...this._dotLottieCore.config(), loopAnimation: i });
  }
  setLoopCount(i) {
    this._dotLottieCore !== null && this._dotLottieCore.setConfig({ ...this._dotLottieCore.config(), loopCount: i });
  }
  setUseFrameInterpolation(i) {
    this._dotLottieCore !== null && this._dotLottieCore.setConfig({ ...this._dotLottieCore.config(), useFrameInterpolation: i });
  }
  ...
  destroy() {
    this._stopAnimationLoop(), this._isStateMachineRunning = false, E && this._canvas instanceof HTMLCanvasElement && (N.unobserve(this._canvas), G.unobserve(this._canvas)), this._stateMachineObserverHandle && (this._dotLottieCore?.stateMachineUnsubscribe(this._stateMachineObserverHandle), this._stateMachineObserverHandle.delete(), this._stateMachineObserverHandle = null), this._stateMachineInternalMessageObserver && (this._dotLottieCore?.stateMachineInternalUnsubscribe(this._stateMachineInternalMessageObserver), this._stateMachineInternalMessageObserver.delete(), this._stateMachineInternalMessageObserver = null), this._dotLottieObserverHandle && (this._dotLottieCore?.unsubscribe(this._dotLottieObserverHandle), this._dotLottieObserverHandle.delete(), this._dotLottieObserverHandle = null), this._dotLottieCore?.delete(), this._dotLottieCore = null, this._context = null, this._eventManager.dispatch({ type: "destroy" }), this._eventManager.removeAllEventListeners(), this._cleanupStateMachineListeners();
  }
  freeze() {
  ...
  resize() {
    if (!(!this._dotLottieCore || !this.isLoaded)) {
      if (E && this._canvas instanceof HTMLCanvasElement) {
        let i = this._renderConfig.devicePixelRatio || window.devicePixelRatio || 1, { height: n, width: u } = this._canvas.getBoundingClientRect();
        n !== 0 && u !== 0 && (this._canvas.width = u * i, this._canvas.height = n * i);
      }
      this._dotLottieCore.resize(this._canvas.width, this._canvas.height) && this._draw();
    }
  }
  setTransform(i) {
    if (!this._dotLottieCore || !L._wasmModule) return false;
    let n = new L._wasmModule.VectorFloat();
    for (let _ of i) n.push_back(_);
    let u = this._dotLottieCore.setTransform(n);
    return u && this._dotLottieCore.render() && this._draw(), u;
  }
  getTransform() {
    if (!this._dotLottieCore) return;
    let i = [0, 0, 0, 0, 0, 0, 0, 0, 0], n = this._dotLottieCore.getTransform();
    for (let u = 0; u < n.size(); u += 1) i[u] = n.get(u);
    return i;
  }
  setSegment(i, n) {
    this._dotLottieCore === null || L._wasmModule === null || this._dotLottieCore.setConfig({ ...this._dotLottieCore.config(), segment: v2([i, n], L._wasmModule) });
  }
  setMode(i) {
    this._dotLottieCore === null || L._wasmModule === null || this._dotLottieCore.setConfig({ ...this._dotLottieCore.config(), mode: f2(i, L._wasmModule) });
  }
  setRenderConfig(i) {
    let { devicePixelRatio: n, freezeOnOffscreen: u, quality: _, ...y } = i;
    this._renderConfig = { ...this._renderConfig, ...y, devicePixelRatio: n || u1(), freezeOnOffscreen: u ?? true, ..._ !== void 0 && { quality: _ } }, _ !== void 0 && this._dotLottieCore && this._dotLottieCore.setQuality(_), E && this._canvas instanceof HTMLCanvasElement && (this._renderConfig.autoResize ? G.observe(this._canvas, this) : G.unobserve(this._canvas), this._renderConfig.freezeOnOffscreen ? (N.observe(this._canvas, this), p1(this._canvas) || this.freeze()) : (N.unobserve(this._canvas), this._isFrozen && this.unfreeze()));
  }
  loadAnimation(i) {
    this._dotLottieCore === null || this._dotLottieCore.activeAnimationId() === i || this._dotLottieCore.loadAnimation(i, this._canvas.width, this._canvas.height) && (this._renderConfig.quality !== void 0 && this._dotLottieCore.setQuality(this._renderConfig.quality), this.resize());
  }
  setMarker(i) {
  ...
  markers() {
    ...
    if (i) {
      let n = [];
      for (let u = 0; u < i.size(); u += 1) {
        let _ = i.get(u);
        n.push({ name: _.name, time: _.time, duration: _.duration });
      }
      return n;
    }
    return [];
  ...
  resetTheme() {
    if (this._dotLottieCore === null) return false;
    let i = this._dotLottieCore.resetTheme();
    return i && (this._dotLottieCore.render(), this._draw()), i;
  }
  setThemeData(i) {
    if (this._dotLottieCore === null) return false;
  ...
  setSlots(i) {
    this._dotLottieCore !== null && this._dotLottieCore.setSlots(i) && (this._dotLottieCore.render(), this._draw());
  }
  setLayout(i) {
    this._dotLottieCore === null || L._wasmModule === null || this._dotLottieCore.setConfig({ ...this._dotLottieCore.config(), layout: p2(i, L._wasmModule) });
  }
  setViewport(i, n, u, _) {
    return this._dotLottieCore === null ? false : this._dotLottieCore.setViewport(i, n, u, _);
  }
  static setWasmUrl(i) {
    G1.setWasmUrl(i);
  }
  tween(i, n) {
    if (!L._wasmModule) return false;
    let u = [0, 0, 1, 1], _ = new L._wasmModule.VectorFloat();
    for (let y of u) _.push_back(y);
    return this._dotLottieCore?.tween(i, n, _) ?? false;
  }
  tweenToMarker(i, n) {
    if (!L._wasmModule) return false;
    let u = [0, 0, 1, 1], _ = new L._wasmModule.VectorFloat();
    for (let y of u) _.push_back(y);
    return this._dotLottieCore?.tweenToMarker(i, n, _) ?? false;
  }
  animationSize() {
    let i = this._dotLottieCore?.animationSize().get(0) ?? 0, n = this._dotLottieCore?.animationSize().get(1) ?? 0;
    return { width: i, height: n };
  }
  getLayerBoundingBox(i) {
    let n = this._dotLottieCore?.getLayerBounds(i);
    if (!n || n.size() !== 8) return;
    let u = [];
    for (let _ = 0; _ < 8; _ += 1) u.push(n.get(_));
    return u;
  }
  static transformThemeToLottieSlots(i, n) {
    return L._wasmModule?.transformThemeToLottieSlots(i, n) ?? "";
  }
  _setupStateMachineObservers() {
    if (!this._dotLottieCore || !L._wasmModule) return;
    let i = new L._wasmModule.CallbackStateMachineObserver();
    i.setOnStart(() => {
      setTimeout(() => {
      ...
      setTimeout(() => {
        this._isStateMachineRunning = false, this._eventManager.dispatch({ type: "stateMachineStop" }), this._dotLottieCore?.isPlaying() || this._stopAnimationLoop();
      }, 0);
    }), i.setOnCustomEvent((u) => {
      this._eventManager.dispatch({ type: "stateMachineCustomEvent", eventName: u });
    }), i.setOnBooleanInputValueChange((u, _, y) => {
      this._eventManager.dispatch({ type: "stateMachineBooleanInputValueChange", inputName: u, newValue: y, oldValue: _ });
    }), i.setOnNumericInputValueChange((u, _, y) => {
      this._eventManager.dispatch({ type: "stateMachineNumericInputValueChange", inputName: u, newValue: y, oldValue: _ });
    }), i.setOnStringInputValueChange((u, _, y) => {
      this._eventManager.dispatch({ type: "stateMachineStringInputValueChange", inputName: u, newValue: y, oldValue: _ });
    }), i.setOnInputFired((u) => {
      this._eventManager.dispatch({ type: "stateMachineInputFired", inputName: u });
    }), i.setOnTransition((u, _) => {
      this._eventManager.dispatch({ type: "stateMachineTransition", fromState: u, toState: _ });
    }), i.setOnStateEntered((u) => {
      this._eventManager.dispatch({ type: "stateMachineStateEntered", state: u });
    }), i.setOnStateExit((u) => {
      this._eventManager.dispatch({ type: "stateMachineStateExit", state: u });
    }), i.setOnError((u) => {
      this._eventManager.dispatch({ type: "stateMachineError", error: u });
    });
    let n = new L._wasmModule.CallbackStateMachineInternalObserver();
    n.setOnMessage((u) => {
      E ? u.startsWith("OpenUrl: ") && Z2(u) : this._eventManager.dispatch({ type: "stateMachineInternalMessage", message: u });
    }), this._stateMachineObserverHandle = this._dotLottieCore.stateMachineSubscribe(i), this._stateMachineInternalMessageObserver = this._dotLottieCore.stateMachineInternalSubscribe(n);
  }
  _cleanupStateMachineObservers() {
    this._stateMachineObserverHandle && (this._dotLottieCore?.stateMachineUnsubscribe(this._stateMachineObserverHandle), this._stateMachineObserverHandle.delete(), this._stateMachineObserverHandle = null), this._stateMachineInternalMessageObserver && (this._dotLottieCore?.stateMachineInternalUnsubscribe(this._stateMachineInternalMessageObserver), this._stateMachineInternalMessageObserver.delete(), this._stateMachineInternalMessageObserver = null);
  }
  stateMachineLoad(i) {
    if (!this._dotLottieCore || !L._wasmModule) return false;
    this._cleanupStateMachineObservers();
    let n = this._dotLottieCore.stateMachineLoad(i);
    return n && this._setupStateMachineObservers(), n;
  }
  stateMachineLoadData(i) {
    if (!this._dotLottieCore || !L._wasmModule) return false;
    this._cleanupStateMachineObservers();
    let n = this._dotLottieCore.stateMachineLoadData(i);
    return n && this._setupStateMachineObservers(), n;
  }
  stateMachineSetConfig(i) {
    this._stateMachineConfig = i;
  }
  stateMachineStart() {
    if (L._wasmModule === null || this._dotLottieCore === null) return false;
    let i = L._wasmModule.createDefaultOpenUrlPolicy();
    if (this._stateMachineConfig) {
      let u = this._stateMachineConfig.openUrlPolicy;
      if (u && typeof u.requireUserInteraction == "boolean" && (i.requireUserInteraction = u.requireUserInteraction), u?.whitelist) {
        i.whitelist = new L._wasmModule.VectorString();
        for (let _ of u.whitelist) i.whitelist.push_back(_);
      }
    }
    let n = this._dotLottieCore.stateMachineStart(i);
    return n && (this._isStateMachineRunning = true, this._setupStateMachineListeners(), this._startAnimationLoop()), n;
  }
  stateMachineStop() {
    if (!this._dotLottieCore) return false;
    let i = this._dotLottieCore.stateMachineStop();
    return i && (this._cleanupStateMachineObservers(), this._isStateMachineRunning = false, this._cleanupStateMachineListeners(), this._dotLottieCore.isPlaying() || this._stopAnimationLoop()), i;
  }
  ...
  stateMachineOverrideState(i, n = false) {
    return this._dotLottieCore?.stateMachineOverrideCurrentState(i, n) ?? false;
  }
  stateMachineGet(i) {
    return this._dotLottieCore?.getStateMachine(i) ?? "";
  }
  stateMachineGetListeners() {
    if (!this._dotLottieCore) return [];
    let i = this._dotLottieCore.stateMachineFrameworkSetup(), n = [];
    for (let u = 0; u < i.size(); u += 1) n.push(i.get(u));
    return n;
  }
  stateMachineSetBooleanInput(i, n) {
    return this._dotLottieCore?.stateMachineSetBooleanInput(i, n) ?? false;
  }
  stateMachineSetNumericInput(i, n) {
    return this._dotLottieCore?.stateMachineSetNumericInput(i, n) ?? false;
  }
  stateMachineSetStringInput(i, n) {
    return this._dotLottieCore?.stateMachineSetStringInput(i, n) ?? false;
  }
  stateMachineGetBooleanInput(i) {
    return this._dotLottieCore?.stateMachineGetBooleanInput(i);
  }
  stateMachineGetNumericInput(i) {
    return this._dotLottieCore?.stateMachineGetNumericInput(i);
  }
  stateMachineGetStringInput(i) {
    return this._dotLottieCore?.stateMachineGetStringInput(i);
  }
  stateMachineGetInputs() {
    if (!this._dotLottieCore) return [];
    let i = this._dotLottieCore.stateMachineGetInputs(), n = [];
    for (let u = 0; u < i.size(); u += 1) n.push(i.get(u));
    return n;
  }
  stateMachineFireEvent(i) {
    this._dotLottieCore?.stateMachineFireEvent(i);
  }
  stateMachinePostClickEvent(i, n) {
    this._dotLottieCore?.stateMachinePostClickEvent(i, n);
  }
  stateMachinePostPointerUpEvent(i, n) {
    this._dotLottieCore?.stateMachinePostPointerUpEvent(i, n);
  }
  stateMachinePostPointerDownEvent(i, n) {
    this._dotLottieCore?.stateMachinePostPointerDownEvent(i, n);
  }
  stateMachinePostPointerMoveEvent(i, n) {
    this._dotLottieCore?.stateMachinePostPointerMoveEvent(i, n);
  }
  stateMachinePostPointerEnterEvent(i, n) {
    this._dotLottieCore?.stateMachinePostPointerEnterEvent(i, n);
  }
  stateMachinePostPointerExitEvent(i, n) {
    this._dotLottieCore?.stateMachinePostPointerExitEvent(i, n);
  }
  _onClick(i) {
    let n = B(i);
...
var r0 = class {
  constructor() {
    m(this, "_workers", /* @__PURE__ */ new Map()), m(this, "_animationWorkerMap", /* @__PURE__ */ new Map());
  }
  getWorker(h) {
    return this._workers.has(h) || this._workers.set(h, new a0()), this._workers.get(h);
  }
  assignAnimationToWorker(h, i) {
    this._animationWorkerMap.set(h, i);
  }
  unassignAnimationFromWorker(h) {
    this._animationWorkerMap.delete(h);
  }
  sendMessage(h, i, n) {
    this.getWorker(h).postMessage(i, n || []);
  }
  terminateWorker(h) {
    let i = this._workers.get(h);
    i && (i.terminate(), this._workers.delete(h));
  }
};
function q2(h, i) {
  if (h instanceof HTMLCanvasElement) {
    let { height: n, width: u } = h.getBoundingClientRect();
    if (n !== 0 && u !== 0) return { width: u * i, height: n * i };
  }
...
var m2 = class h1 {
  ...
  async play() {
    this._created && (await this._sendMessage("play", { instanceId: this._id }), await this._updateDotLottieInstanceState(), E && this._canvas instanceof HTMLCanvasElement && this._dotLottieInstanceState.renderConfig.freezeOnOffscreen && !p1(this._canvas) && await this.freeze());
  }
  async pause() {
  ...
  async setSpeed(i) {
    this._created && (await this._sendMessage("setSpeed", { instanceId: this._id, speed: i }), await this._updateDotLottieInstanceState());
  }
  async setMode(i) {
    this._created && (await this._sendMessage("setMode", { instanceId: this._id, mode: i }), await this._updateDotLottieInstanceState());
  }
  async setFrame(i) {
    this._created && (await this._sendMessage("setFrame", { frame: i, instanceId: this._id }), await this._updateDotLottieInstanceState());
  }
  async setSegment(i, n) {
    this._created && (await this._sendMessage("setSegment", { instanceId: this._id, segment: [i, n] }), await this._updateDotLottieInstanceState());
  }
  async setRenderConfig(i) {
    if (!this._created) return;
    let { devicePixelRatio: n, freezeOnOffscreen: u, quality: _, ...y } = i;
    await this._sendMessage("setRenderConfig", { instanceId: this._id, renderConfig: { ...this._dotLottieInstanceState.renderConfig, ...y, devicePixelRatio: n || u1(), freezeOnOffscreen: u ?? true, ..._ !== void 0 && { quality: _ } } }), await this._updateDotLottieInstanceState(), E && this._canvas instanceof HTMLCanvasElement && (this._dotLottieInstanceState.renderConfig.autoResize ? G.observe(this._canvas, this) : G.unobserve(this._canvas), this._dotLottieInstanceState.renderConfig.freezeOnOffscreen ? (N.observe(this._canvas, this), p1(this._canvas) || await this.freeze()) : (N.unobserve(this._canvas), this._dotLottieInstanceState.isFrozen && await this.unfreeze()));
  }
  async setUseFrameInterpolation(i) {
    this._created && (await this._sendMessage("setUseFrameInterpolation", { instanceId: this._id, useFrameInterpolation: i }), await this._updateDotLottieInstanceState());
  }
  async setTheme(i) {
  ...
  async load(i) {
    this._created && (await this._sendMessage("load", { config: i, instanceId: this._id }), await this._updateDotLottieInstanceState());
  }
  async setLoop(i) {
    this._created && (await this._sendMessage("setLoop", { instanceId: this._id, loop: i }), await this._updateDotLottieInstanceState());
  }
  async setLoopCount(i) {
    this._created && (await this._sendMessage("setLoopCount", { instanceId: this._id, loopCount: i }), await this._updateDotLottieInstanceState());
  }
  async resize() {
    if (!this._created) return;
    let { height: i, width: n } = q2(this._canvas, this._dotLottieInstanceState.renderConfig.devicePixelRatio || u1());
    await this._sendMessage("resize", { height: i, instanceId: this._id, width: n }), await this._updateDotLottieInstanceState();
  }
  async destroy() {
    this._created && (this._created = false, await this._sendMessage("destroy", { instanceId: this._id }), this._cleanupStateMachineListeners(), h1._workerManager.unassignAnimationFromWorker(this._id), this._eventManager.removeAllEventListeners(), E && this._canvas instanceof HTMLCanvasElement && (N.unobserve(this._canvas), G.unobserve(this._canvas)));
  }
  async freeze() {
  ...
  async setBackgroundColor(i) {
    this._created && (await this._sendMessage("setBackgroundColor", { instanceId: this._id, backgroundColor: i }), await this._updateDotLottieInstanceState());
  }
  async loadAnimation(i) {
    this._created && (await this._sendMessage("loadAnimation", { animationId: i, instanceId: this._id }), await this._updateDotLottieInstanceState());
  }
  async setLayout(i) {
    this._created && (await this._sendMessage("setLayout", { instanceId: this._id, layout: i }), await this._updateDotLottieInstanceState());
  }
  async _updateDotLottieInstanceState() {
    if (!this._created) return;
    let i = await this._sendMessage("getDotLottieInstanceState", { instanceId: this._id });
  ...
  async setMarker(i) {
    this._created && (await this._sendMessage("setMarker", { instanceId: this._id, marker: i }), await this._updateDotLottieInstanceState());
  }
  async setThemeData(i) {
    if (!this._created) return false;
    let n = await this._sendMessage("setThemeData", { instanceId: this._id, themeData: i });
    return await this._updateDotLottieInstanceState(), n;
  }
  async setViewport(i, n, u, _) {
    return this._created ? this._sendMessage("setViewport", { x: i, y: n, width: u, height: _, instanceId: this._id }) : false;
  }
  async animationSize() {
    return this._created ? this._sendMessage("animationSize", { instanceId: this._id }) : { height: 0, width: 0 };
  }
  async tween(i, n) {
    return this._created ? this._sendMessage("tween", { instanceId: this._id, frame: i, duration: n }) : false;
  }
  async tweenToMarker(i, n) {
    return this._created ? this._sendMessage("tweenToMarker", { instanceId: this._id, marker: i, duration: n }) : false;
  }
  async setTransform(i) {
    return this._created ? this._sendMessage("setTransform", { instanceId: this._id, transform: i }) : false;
  }
  async getTransform() {
    if (this._created) return this._sendMessage("getTransform", { instanceId: this._id });
  }
  async _sendMessage(i, n, u) {
    let _ = { id: `dotlottie-request-${K2()}`, method: i, params: n };
    return this._worker.postMessage(_, u || []), new Promise((y, c) => {
      let W = (V) => {
        let J = V.data;
        J.id === _.id && (this._worker.removeEventListener("message", W), J.error ? c(new Error(`Failed to execute method ${i}: ${J.error}`)) : y(J.result));
      };
      this._worker.addEventListener("message", W);
    });
  }
  addEventListener(i, n) {
    this._eventManager.addEventListener(i, n);
  ...
  async stateMachineLoad(i) {
    if (!this._created) return false;
    let n = await this._sendMessage("stateMachineLoad", { instanceId: this._id, stateMachineId: i });
    return await this._updateDotLottieInstanceState(), n;
  }
  async stateMachineLoadData(i) {
    if (!this._created) return false;
    let n = await this._sendMessage("stateMachineLoadData", { instanceId: this._id, stateMachineData: i });
    return await this._updateDotLottieInstanceState(), n;
  }
  async stateMachineStart() {
    if (!this._created) return false;
    let i = await this._sendMessage("stateMachineStart", { instanceId: this._id });
    return i && (this._setupStateMachineListeners(), await this._updateDotLottieInstanceState()), i;
  }
  ...
  async stateMachineSetNumericInput(i, n) {
    return this._created ? this._sendMessage("stateMachineSetNumericInput", { instanceId: this._id, name: i, value: n }) : false;
  }
  async stateMachineSetBooleanInput(i, n) {
    return this._created ? this._sendMessage("stateMachineSetBooleanInput", { instanceId: this._id, name: i, value: n }) : false;
  }
  async stateMachineSetConfig(i) {
    this._created && this._sendMessage("stateMachineSetConfig", { instanceId: this._id, config: i });
  }
  async stateMachineSetStringInput(i, n) {
    return this._created ? this._sendMessage("stateMachineSetStringInput", { instanceId: this._id, name: i, value: n }) : false;
  }
  async stateMachineGetNumericInput(i) {
    if (this._created) return this._sendMessage("stateMachineGetNumericInput", { instanceId: this._id, name: i });
  }
  async stateMachineGetBooleanInput(i) {
    if (this._created) return this._sendMessage("stateMachineGetBooleanInput", { instanceId: this._id, name: i });
  }
  async stateMachineGetStringInput(i) {
    if (this._created) return this._sendMessage("stateMachineGetStringInput", { instanceId: this._id, name: i });
  }
  async stateMachineGetInputs() {
    if (this._created) return this._sendMessage("stateMachineGetInputs", { instanceId: this._id });
  }
  async stateMachineFireEvent(i) {
    this._created && this._sendMessage("stateMachineFireEvent", { instanceId: this._id, name: i });
  }
  ...
  async stateMachineOverrideState(i, n = false) {
    return this._created ? this._sendMessage("stateMachineOverrideState", { instanceId: this._id, state: i, immediate: n }) : false;
  }
  async stateMachineGet(i) {
    return this._created ? this._sendMessage("stateMachineGet", { instanceId: this._id, stateMachineId: i }) : "";
  }
  async stateMachineGetListeners() {
    return this._created ? this._sendMessage("stateMachineGetListeners", { instanceId: this._id }) : [];
  }
  async stateMachinePostClickEvent(i, n) {
    if (this._created) return this._sendMessage("stateMachinePostClickEvent", { instanceId: this._id, x: i, y: n });
  }
  async stateMachinePostPointerUpEvent(i, n) {
    if (this._created) return this._sendMessage("stateMachinePostPointerUpEvent", { instanceId: this._id, x: i, y: n });
  }
  async stateMachinePostPointerDownEvent(i, n) {
    if (this._created) return this._sendMessage("stateMachinePostPointerDownEvent", { instanceId: this._id, x: i, y: n });
  }
  async stateMachinePostPointerMoveEvent(i, n) {
    if (this._created) return this._sendMessage("stateMachinePostPointerMoveEvent", { instanceId: this._id, x: i, y: n });
  }
  async stateMachinePostPointerEnterEvent(i, n) {
    if (this._created) return this._sendMessage("stateMachinePostPointerEnterEvent", { instanceId: this._id, x: i, y: n });
  }
  async stateMachinePostPointerExitEvent(i, n) {
    if (this._created) return this._sendMessage("stateMachinePostPointerExitEvent", { instanceId: this._id, x: i, y: n });
  }
  _onClick(i) {
    let n = B(i);
  ...
  async _setupStateMachineListeners() {
    if (E && this._canvas instanceof HTMLCanvasElement && this.isLoaded) {
      let i = await this._sendMessage("stateMachineGetListeners", { instanceId: this._id });
...
m(m2, "_workerManager", new r0()), m(m2, "_wasmUrl", "");
var J1 = m2;
var K1 = ({ animationId: h, autoplay: i, backgroundColor: n, className: u, createDotLottie: _, data: y, dotLottieRefCallback: c, layout: W, loop: V, mode: J, playOnHover: m1, renderConfig: d1, segment: D, speed: c1, src: q, stateMachineConfig: i1, stateMachineId: K, style: l1, themeData: _1, themeId: z, useFrameInterpolation: O, workerId: n1, ...Z }) => {
  let w = (0, import_react.useRef)(null), C = (0, import_react.useRef)(null), g1 = (0, import_react.useRef)(c), L1 = { speed: c1, mode: J, loop: V, useFrameInterpolation: O, segment: D, backgroundColor: n, autoplay: i, themeId: z, workerId: n1, src: q, data: y, layout: W, renderConfig: d1, animationId: h, stateMachineConfig: i1, stateMachineId: K }, r1 = (0, import_react.useRef)(L1);
  g1.current = c, r1.current = L1;
  let A1 = (0, import_react.useCallback)((x) => {
    C.current = x, x ? w.current = _({ ...r1.current, canvas: x }) : (w.current?.destroy(), w.current = null), g1.current?.(w.current);
  }, []);
  return (0, import_react.useEffect)(() => {
    let x = (w1) => {
      m1 && (w1.type === "mouseenter" && w.current?.play(), w1.type === "mouseleave" && w.current?.pause());
    };
    return C.current?.addEventListener("mouseenter", x), C.current?.addEventListener("mouseleave", x), () => {
      C.current?.removeEventListener("mouseenter", x), C.current?.removeEventListener("mouseleave", x);
    };
  }, [m1]), (0, import_react.useEffect)(() => {
    w.current?.setSpeed(c1 ?? 1);
  }, [c1]), (0, import_react.useEffect)(() => {
    w.current?.setMode(J ?? "forward");
  }, [J]), (0, import_react.useEffect)(() => {
    w.current?.setLoop(V ?? false);
  }, [V]), (0, import_react.useEffect)(() => {
    w.current?.setUseFrameInterpolation(O ?? true);
  }, [O]), (0, import_react.useEffect)(() => {
    typeof D?.[0] == "number" && typeof D[1] == "number" && w.current?.setSegment(D[0], D[1]);
  }, [D]), (0, import_react.useEffect)(() => {
    w.current?.setBackgroundColor(n ?? "");
  }, [n]), (0, import_react.useEffect)(() => {
    w.current?.setRenderConfig(d1 ?? {});
  }, [JSON.stringify(d1)]), (0, import_react.useEffect)(() => {
    typeof y != "string" && typeof y != "object" || w.current?.load({ data: y, ...r1.current });
  }, [y]), (0, import_react.useEffect)(() => {
    typeof q == "string" && w.current?.load({ src: q, ...r1.current });
  }, [q]), (0, import_react.useEffect)(() => {
    w.current?.setMarker(Z.marker ?? "");
  }, [Z.marker]), (0, import_react.useEffect)(() => {
    w.current?.loadAnimation(h ?? "");
  }, [h]), (0, import_react.useEffect)(() => {
    typeof z == "string" && w.current?.setTheme(z);
  }, [z]), (0, import_react.useEffect)(() => {
    w.current?.setThemeData(_1 ?? "");
  }, [_1]), (0, import_react.useEffect)(() => {
    w.current?.setLayout(W ?? {});
  }, [W?.fit, W?.align && W.align[0], W?.align && W.align[1]]), (0, import_react.useEffect)(() => {
    w.current?.isLoaded && (typeof K == "string" && K ? w.current.stateMachineLoad(K) && w.current.stateMachineStart() : w.current.stateMachineStop());
  }, [K]), (0, import_react.useEffect)(() => {
    w.current?.stateMachineSetConfig(i1 ?? null);
  }, [i1]), (0, import_jsx_runtime.jsx)("div", { className: u, ...!u && { style: { width: "100%", height: "100%", lineHeight: 0, ...l1 } }, children: (0, import_jsx_runtime.jsx)("canvas", { ref: A1, style: { width: "100%", height: "100%" }, ...Z }) });
};
var o0 = (h) => new V1(h);
var O0 = (h) => (0, import_jsx_runtime.jsx)(K1, { ...h, createDotLottie: o0 });
var u0 = (h) => new J1(h);
var T0 = (h) => (0, import_jsx_runtime.jsx)(K1, { ...h, createDotLottie: u0 });
var x0 = (h) => {
  J1.setWasmUrl(h), V1.setWasmUrl(h);
};
export {
  O0 as DotLottieReact,
  T0 as DotLottieWorkerReact,
  x0 as setWasmUrl
};
