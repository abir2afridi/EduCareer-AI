      ...
      <Card className="border-border/60">
        <CardHeader className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          <div>
            ...
            <CardDescription>
              Review AI quiz performance across all learners. Filter by student or topic and drill down into every attempt.
            </CardDescription>
          </div>
        ...
        <AnimatePresence>
          {filteredAttempts.length === 0 ? (
            ...
            >
              ...
              <p>No quiz attempts match what you’re looking for.</p>
            </motion.div>
          ) : (
